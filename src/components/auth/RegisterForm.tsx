...
export default function RegisterForm({ onSwitchToLogin }: Props) {
  ...
  // Email appena registrata: valorizzata dopo il successo per mostrare la verifica
  ...
  function handleSubmit(e: FormEvent) {
    ...
    register(
      ...
      {
        onSuccess: () => {
          // Mostra il form di verifica email con l'email appena registrata
  ...
  // Dopo la registrazione → verifica email
  if (registeredEmail) {
    return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-md p-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">Crea un nuovo account</p>
        </div>
