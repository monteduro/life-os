...
- `Upcoming` reminder view with overdue/today/later grouping
- reminder completion state with overdue/completed visual status
...
- richer calendar-oriented reminder and due-date views
