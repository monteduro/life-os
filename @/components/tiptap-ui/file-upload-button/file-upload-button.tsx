...
/**
 * Button component for uploading/inserting files (PDF, documents, etc.) in a Tiptap editor.
 *
 * For custom button implementations, use the `useFileUpload` hook instead.
 */
